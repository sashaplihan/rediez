...
?>
	...
	<?php if ( !is_user_logged_in() && carbon_get_post_meta( get_the_ID(), 'show_cta_section' ) ) : ?>
		<section class="cta">
			<div class="container">
				<div class="row">
					<div class="cta__content">
						...
						<div class="cta__button">
							<button class="cta__link title_link btn--primary" data-micromodal-trigger="modal-auth">
